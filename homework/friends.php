<html>
    ...
    <body>
        ...
        <form class="form-inline text-center" action="friends.php" method="post">
                    ...
                    if (isset($_POST['nameFilter']) && !empty($_POST['nameFilter'])) {
                            ...
                            for( $i = 0; $i < count($names) - 2; $i++ ){
                                ...
                                if(strstr($names[$i],$_POST['nameFilter'])){
                                    ...
                                    echo '<a href="friends.php?deleteFriend=' . $names[$i] .'" class="btn btn-primary">Delete</a>';
                                    echo '</div>';
                                    echo '</div>';
                            ...
                            if(strstr($names[$i],$_POST['nameFilter'])){
                                ...
                                echo '<p class="card-text">Some example text.</p>';
                                echo '<a href="friends.php?deleteFriend=' . $names[count($names) - 2] .'" class="btn btn-primary">Delete</a>';
                                echo '</div>';
                                echo '</div>';
                            }
        ...
        <form class="form-inline text-center" action="friends.php" method="post">
            <p class="col-centered">
            <input type="text" class="form-control" name="nameFilter" value="<?=$nameFilter?>" style="margin-left: 20px;margin-right: 10px;">
